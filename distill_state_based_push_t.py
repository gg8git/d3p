        ...
        for epoch_idx in tglobal:
            ...
            if epoch_idx % 10 == 0:
                ...
                metrics = evaluate_policy_vectorized(
                    ...
                    stats=stats,
                    device=device,
                    policy=policy  # should be ema_policy (?)
                )
...
def main():
    ...
    # Distillation args
    parser.add_argument("--student_size", type=str, default="large", help="size of student model unet [tiny, small, medium, large]")
    parser.add_argument("--teacher_ckpt_path", type=str, default="pusht_state_100ep.ckpt", help="checkpoint path to teacher ema weights")
